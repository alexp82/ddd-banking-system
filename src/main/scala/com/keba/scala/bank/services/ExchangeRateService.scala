...
class ExchangeRateService {
  ...
  /* Field(s): */
  private val exchangeRateMap: scala.collection.mutable.Map[(Currency, Currency), BigDecimal] =
    mutable.Map()
  ...
  /**
    * Calculates the
    */
  private def performRegularTwoCurrencyExchange(inMoneyToExchange: Money, inToCurrency: Currency): Option[Money] = {
    val theCurrencyDirection = (inMoneyToExchange.currency, inToCurrency)
